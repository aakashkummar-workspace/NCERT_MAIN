-- CreateEnum
CREATE TYPE "OrganizationType" AS ENUM ('SOLO_TEACHER', 'TUITION_CENTRE', 'COACHING_INSTITUTE', 'SCHOOL');
...
-- CreateEnum
CREATE TYPE "MemberRole" AS ENUM ('OWNER', 'ADMIN', 'TEACHER', 'STUDENT', 'PARENT');
...
CREATE TABLE "organizations" (
    ...
    "name" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "type" "OrganizationType" NOT NULL DEFAULT 'SOLO_TEACHER',
...
-- CreateIndex
CREATE INDEX "invitations_organization_id_role_idx" ON "invitations"("organization_id", "role");
